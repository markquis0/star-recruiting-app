...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Star Recruiting'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/" id="home-link">
                <img src="<?php echo e(asset('images/star-recruiting-logo.png')); ?>" alt="Star Recruiting Logo" id="logo-img" style="height: 40px; width: auto;" onerror="this.style.display='none'; document.getElementById('logo-text').style.display='inline';">
...
<?php /**PATH /Users/markquissimmons/star-recruiting-app/resources/views/layouts/app.blade.php ENDPATH**/ ?>