...
<body>
    ...
    <nav class="landing-navbar">
        <a href="/" class="landing-navbar-brand">
            <img src="<?php echo e(asset('images/star-recruiting-logo.png')); ?>" alt="Star Recruiting Logo" onerror="this.style.display='none';">
    ...
    <section class="hero-section">
        ...
        <div class="hero-image">
            <img src="<?php echo e(asset('images/illustration-hiring.png')); ?>" alt="Recruiting illustration" onerror="this.style.display='none';">
        </div>
    </section>
    ...
    <footer class="landing-footer">
        © <?php echo e(date('Y')); ?> Star Recruiting. All rights reserved.
    </footer>
...
<?php /**PATH /Users/markquissimmons/star-recruiting-app/resources/views/welcome.blade.php ENDPATH**/ ?>